...
public class BoardDisplay extends JPanel implements Observer {
  ...
  /**
   * True if the game has been ended, false if not.
   */
  ...
  /**
   * Alters the pause state of the game.
   */
  ...
  /**
   * Returns whether or not the game is currently over.
   * 
